/*
  ...
  - The values [VOTING_CLOSED] on the enum `AdminControlType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "AdminControlType_new" AS ENUM ('VOTING_ENABLED', 'QUESTION', 'EMBED', 'IMAGE');
